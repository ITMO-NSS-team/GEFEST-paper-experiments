...
"""
IMPORTANT NOTE: to run this script you should have COMSOL Multiphysics and MPh library 
!pip install MPh
...
parser.add_argument('--path_to_sampler', type=str, default=False,
...
domain, task_setup = sd_domain.configurate_domain(poly_num=opt.n_polys,
...
optimizer = sd_optimizer.configurate_optimizer(pop_size=opt.pop_size,
