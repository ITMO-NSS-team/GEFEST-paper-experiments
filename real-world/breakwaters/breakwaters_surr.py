...
This file contains short configurated script for generative design of breakwaters with Surrogate model
More details see in https://github.com/quickjkee/GEFEST/tree/main/cases/breakwaters

The paper results are contained in /result_paper/BW_SURR1(2,3)
To open it use pickle library. Each file (archive_i.pickle) contains 
coordinates of polygons, fitness function and objectives. 
Note that to open it you should have GEFEST installed.
"""
...
parser.add_argument('--path_to_sur', type=str, default='surrogate_model/bw_surrogate_700_train.h5',
