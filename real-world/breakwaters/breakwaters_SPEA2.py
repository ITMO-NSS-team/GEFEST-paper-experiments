...
from cases.breakwaters.configuration_de import bw_domain, bw_sampler, bw_estimator
...
This file contains short configurated script for generative design of breakwaters with SPEA2
More details see in https://github.com/quickjkee/GEFEST/tree/main/cases/breakwaters

The paper results are contained in /result_paper/BW_SPEA2_80_epochs_30_1(2,3)
